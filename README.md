...
![AUR version](https://img.shields.io/aur/version/mint-backgrounds-sylvia?label=AUR)
[![Build Status](https://drone.cryptic.systems/api/badges/volker.raschek/mint-backgrounds-sylvia-pkg/status.svg)](https://drone.cryptic.systems/volker.raschek/mint-backgrounds-sylvia-pkg)
![AUR votes](https://img.shields.io/aur/votes/mint-backgrounds-sylvia)

This repository contains build files to build the Arch Linux package `mint-backgrounds-sylvia`. Instead of building the
...
```bash
yay --sync --aur mint-backgrounds-sylvia
```
...
sudo pacman --sync mint-backgrounds-sylvia
```
